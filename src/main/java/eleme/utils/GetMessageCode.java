...
public class GetMessageCode {
    ...
    private static final String ACCOUNT_SID = "4cacb288612e49ac8d45fff344d4aade";
    //AUTH_TOKEN是秒嘀的开发者信息中的AUTH TOKEN，需要自己去秒嘀网站获取
    private static final String AUTH_TOKEN = "2229cadde24d43db96c9c4afdf6b7dfe";
    ...
    public static String getCode(String phone,String code){
        ...
        //random 是生成的验证码。
        String tamp = "【小馨科技】尊敬的用户，您的验证码为"+code;
